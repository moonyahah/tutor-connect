/*
 * Purpose: Handles user login and routes to the correct dashboard.
 * Design: Android Activity coordinating AuthService and navigation.
 * Outstanding issues: Add loading state and null-current-user handling.
 */
                ...
                runOnUiThread(() -> {
                    ...
                    if (role.equals("tutor")) {
                        ...
                        new com.example.seproject.services.FirestoreService()
                                .getTutorProfile(uid, new com.example.seproject.services.TutorProfileCallback() {
                                    @Override
