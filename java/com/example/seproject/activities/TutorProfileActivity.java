/*
 * Purpose: Displays a tutor's profile details and request action.
 * Design: Android Activity composing Firestore service calls.
 * Outstanding issues: Handle null tutorId and show loading/error states.
 */
...
public class TutorProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firestoreService.getTutorProfile(tutorId, new TutorProfileCallback() {
            ...
            @Override
            public void onFailure(String message) {
                Toast.makeText(TutorProfileActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        toolbar.setNavigationOnClickListener(v -> {
            Intent intent = new Intent(TutorProfileActivity.this, StudentDashboardActivity.class);
            startActivity(intent);
            finish();
        });
    }
