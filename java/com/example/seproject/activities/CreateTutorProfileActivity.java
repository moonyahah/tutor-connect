/*
 * Purpose: Collects tutor profile details and saves them to Firestore.
 * Design: Android Activity for profile creation workflow.
 * Outstanding issues: Trim/validate subjects and prevent double submits.
 */
...
public class CreateTutorProfileActivity extends AppCompatActivity {
    ...
    private EditText subjectsInput, bioInput;
    ...
    private void saveProfile() {
        ...
        TutorProfile profile = new TutorProfile(userId, subjects, bio);
