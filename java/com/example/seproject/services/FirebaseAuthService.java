/*
 * Purpose: Firebase-backed implementation of AuthService with Firestore user lookup.
 * Design: Service layer encapsulating FirebaseAuth interactions.
 * Outstanding issues: Handle null currentUser and surface richer error types.
 */
